...
T.Menu
{
    ...
    T.Overlay.modal: Rectangle  {
        color: Qt.rgba(control.Youi.Theme.backgroundColor.r,
                       control.Youi.Theme.backgroundColor.g,
                       control.Youi.Theme.backgroundColor.b, 0.4)
        Behavior on opacity {
            NumberAnimation {
                duration: 150
                easing.type: Easing.InOutCubic
