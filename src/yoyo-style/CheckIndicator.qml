...
Rectangle {
    ...
    color: !control.enabled ? control.Youi.Theme.secondBackgroundColor
                            : checked ? Youi.Theme.highlightColor : control.Youi.Theme.secondBackgroundColor
    border.color: !control.enabled ? control.Youi.Theme.disabledTextColor
        : checked ? control.Youi.Theme.highlightColor: control.Youi.Theme.textColor
    border.width: 1
